...
def create_validate_code(size=(120, 30),
    ...
    # img = img.transform(size,PIL.Image.PERSPECTIVE, params)  # 创建扭曲
...
def check_code(request):
    stream = BytesIO()
    # 生成图片img，数字代码code，保存在内存中，而不是在Django项目中
...
def register(request):
    ...
    return render(request,'flatter/register.html')
